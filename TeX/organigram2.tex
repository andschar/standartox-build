...
\node[text=red] (io) [io, align = left] at (-3cm,4cm) {Table of Chemicals \\ CAS, Compound name}; % coordinates: (current page.east)
...
%% final result
\node (testres) [res] at (18,-5) {Final result}
...
%% entities
\node (test) [res] at (-10,-10) {Test}; %debuging
