...
\begin{document}
	...
	\node (filtres) [res, right of = appbox_shiny, xshift = -3.5cm] {Filter};
	...
	\node (filter) [res, right of = testres2, xshift = 2cm] {re\_filter.R};
	\node (analyses) [res, right of = filter, xshift = 2cm] {re\_analyses.R};
	...
	% arrows
	\draw [arrow] (testres2.east) -- (filter.west);
	\draw [arrow] (filter.east) -- (analyses.west);
