...
CREATE TABLE taxa.taxa_continent AS (
	SELECT
		...
		GREATEST(gb.europe)::boolean AS europe,
...
CREATE TABLE taxa.taxa_country AS (
	SELECT 
		...
		GREATEST(gb.be)::boolean AS be,
		GREATEST(gb.bf)::boolean AS bf,
		GREATEST(gb.bg)::boolean AS bg,
		...
		GREATEST(gb.cz)::boolean AS cz,
		GREATEST(gb.de)::boolean AS de,
		GREATEST(gb.dj)::boolean AS dj,
		GREATEST(gb.dk)::boolean AS dk,
		...
		GREATEST(gb.lt)::boolean AS lt,
		GREATEST(gb.lu)::boolean AS lu,
		GREATEST(gb.lv)::boolean AS lv,
		...
		GREATEST(gb.nl)::boolean AS nl,
		GREATEST(gb.no)::boolean AS no,
