...
# nematoda ----------------------------------------------------------------
tax[ phylum_division == 'Nemata', `:=` (nematoda = 1L, heterotroph = 1L, invertebrates_mikro = 1L, ecotox_group2 = 'Nemata') ]

# bryozoa -----------------------------------------------------------------
tax[ phylum_division == 'Bryozoa', `:=` (bryozoa = 1L, heterotroph = 1L, invertebrates_mikro = 1L, ecotox_group2 = 'Bryozoa') ]
...
# NA ecotox group ---------------------------------------------------------
tax[ is.na(ecotox_group2) & ecotox_group == 'Fish', ecotox_group2 := 'Fish' ]
tax[ is.na(ecotox_group2) & ecotox_group == 'Algae', ecotox_group2 := 'Algae' ]
tax[ is.na(ecotox_group2) & ecotox_group == 'Crustaceans', ecotox_group2 := 'Crustacea' ]
