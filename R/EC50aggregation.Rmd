...
```{r subst1}
## load data
psm = readRDS(file.path(cachedir, 'psm1.rds')) # created in EC50sensitivity_data.Rmd
psm = psm[ !is.na(casnr) ] # only metabolite and sumed pesticides
psm = psm[ !subst_name %in% c('Desethylsimazin') ] # casnr: 1007289; duplicated with Desethylsimazin

## for Nadin and verena
