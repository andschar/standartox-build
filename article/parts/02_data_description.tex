...
\citet{vandenberg_modeling_2019} used ECOTOX for trait-based sensitivity models. \include{article/values/publish_rate.tex}


\subsection{Outlook}
Standartox is not a one point in time effort, but an automated tool that steadily incorporates newly published ecotoxicity data. The ECOTOX database added on average \verbatiminput{article/values/test.txt} new test results in the five last years.
