...
\iffalse
 Könnten Aspekte von oben nicht noch in das Organigramm (e.g. Cleaning units and test durations)... Weitere Anmerkungen zur Abbildung: Die Daten EPA Ecotox und Standardtox sind irgendwie auf der gleichen Ebene - aber wozu ist die EPA da noch drin? Warum geht der flowchart nicht von so, dass irgendwas auf standartox data set mit Pfeil geht? Dann wird aus der API das R package? Insgesamt schön zur Visualisierung usw., aber die Logik ist unklar und kann einfacher gehalten werden
\fi
