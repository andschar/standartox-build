...
\begin{tikzpicture}
%% processing
\node (epa-ecotox) [ecotox, above of = ecotox-id, align=center, xshift = -3cm, yshift = 4cm] {\Large EPA ECOTOX\\\Large raw data};
\node (ecotox-id) [standartox, align = center] at (-3cm,0cm) {\Large Identifiers};
...
\node (taxa) [ids, below of = cas, xshift = 0cm, yshift = -2.5cm] {\Large Taxa};
...
%% standartox
\node (stx-data) [standartox, below of = ecotox-chck, xshift = 3cm, yshift = -2.5cm, align = center] {\Large Standartox\\\Large data set};
