...
%
%\begin{filecontents*}{data/scripts.csv}
%	
%\end{filecontents*}


%\input{data/scripts.csv}


%
%\begin{tabular}{l|c}
%	
%	\csvreader[head to column names]{data/scripts.csv}{}
%	\end{tabular}
