...
\citep{kefford_definition_2011} % paper that shows SSD species richness approximates effect of salinity on macroinvertebrates

\citep{posthuma_species_2002} % describes concept of SSDs first
...
\begin{figure}
    %\includestandalone[]{tikz/test}
    \includestandalone[width=\textwidth]{tikz/organigram}
    %\includestandalone[width=\textwidth]{tikz/organigram}
    \caption{Organigram}
