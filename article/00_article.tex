...
\title{Standartox: A tool to derive exposure endpoints from ecotoxicological test results}
...
%%%%%%%%%%%%%%%%%%%%%% 01 Introduction
\input{article/parts/01_introduction.tex}

%%%%%%%%%%%%%%%%%%%%%% 02 Results and Discussion
\input{article/parts/02_results_discussion.tex}

%%%%%%%%%%%%%%%%%%%%%% 03 Methods
\input{article/parts/03_methods.tex}

%%%%%%%%%%%%%%%%%%%%%% 04 Conclusion
\input{article/parts/04_conclusion.tex}
